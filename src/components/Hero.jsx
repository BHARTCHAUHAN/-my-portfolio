    ...
    return (
        <section className="hero-n8n" id="home">
            <div className="hero-n8n-content">
                <div className="hero-n8n-text" data-aos="fade-right">
                    ...
                    <div className="hero-n8n-buttons" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div className="hero-n8n-social" data-aos="fade-up" data-aos-delay="300">
                ...
                <div className="hero-n8n-image" data-aos="fade-left" data-aos-delay="200">
